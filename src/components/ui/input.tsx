...
const inputVariants = cva(
    `flex min-h-12 w-full bg-white py-2 pl-4 pr-2 gap-2 text-lg text-(--primary) placeholder:text-gray-300 focus:outline-none disabled:bg-gray-700 disabled:text-black disabled:placeholder:text-black disabled:opacity-15 disabled:pointer-events-none`,
    {
        variants: {
            variant: {
